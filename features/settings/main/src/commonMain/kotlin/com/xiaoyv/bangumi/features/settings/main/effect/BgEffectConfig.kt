package com.xiaoyv.bangumi.features.settings.main.effect
...
internal object BgEffectConfig {
    ...
    fun get(deviceType: DeviceType, isDark: Boolean): Config = if (!isDark) OS3_PHONE_LIGHT else OS3_PHONE_DARK
}
