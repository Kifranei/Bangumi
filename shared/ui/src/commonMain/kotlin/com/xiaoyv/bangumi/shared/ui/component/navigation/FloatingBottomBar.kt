...
fun RowScope.FloatingBottomBarItem(
    ...
    Column(
        ...
        CompositionLocalProvider(MiuixLocalContentColor provides contentColor) { content() }
    }
}
...
fun FloatingBottomBar(
    ...
    val containerColor = if (isLiquid) colors.containerColor.copy(0.4f) else colors.containerColor
    ...
    Box(modifier = modifier.fillMaxWidth(), contentAlignment = Alignment.CenterStart) {
                    ...
                    .then(
                        when {
                            isLiquid -> Modifier.drawBackdrop(
                                backdrop = backdrop,
                                shape = { pillShape },
                                effects = { vibrancy(); blur(4.dp.toPx()); lens(24.dp.toPx(), 24.dp.toPx()) },
        ...
        if (isLiquid) {
            CompositionLocalProvider(
                LocalFloatingBottomBarTabScale provides { lerp(1f, 1.2f, dragAnimation.pressProgress) },
                ...
                Box(
                    Modifier
                        ...
                        .drawBackdrop(
                            ...
                            onDrawSurface = {
                                val progress = dragAnimation.pressProgress
                                drawRect(if (!isDark) Color.Black.copy(alpha = 0.1f) else Color.White.copy(alpha = 0.1f), alpha = 1f - progress)
